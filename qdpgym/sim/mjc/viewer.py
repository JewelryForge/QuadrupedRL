...
class ViewerMj:
    ...
    def _key_callback(self, window, key, scancode, action, mods):
        ...
        # Display contact forces
            ...
            self._perturb = not self._perturb
            self.vopt.flags[mujoco.mjtVisFlag.mjVIS_PERTFORCE] = self._perturb
            self.vopt.flags[mujoco.mjtVisFlag.mjVIS_PERTOBJ] = self._perturb
        elif key == glfw.KEY_J:
    ...
    def _add_marker_to_scene(self, marker):
        ...
        g.dataid = -1
        g.objtype = mujoco.mjtObj.mjOBJ_SITE
        g.objid = -1
    ...
    def _create_overlay(self):
        ...
        add_overlay(topleft, "Referenc[e] frames", "On" if self.vopt.frame == 1 else "Off")
